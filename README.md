# automacao-checklists-industriais

## Objetivo

Automação em Python para criação e importação de checklists industriais, reduzindo um processo de aproximadamente 8 minutos para 2,1 segundos.
